...
There are various type of control method available for UR5e with torque control. This work presents a motion control strategy based on the dynamics of the UR5e. To generate the required torque for motion control, The inverse dynamics equation in joint space (equation 1) is used to compute required torque respect to the Joint state\footnote{Joint state: joint position, joint velocity, joint acceleration}. To control position, velocity and acceleration of the UR5e using PD motion controller (equation 2)
